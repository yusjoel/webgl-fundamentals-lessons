...
function Curve(points) {
    ...
    for (let i = 0; i < this.count; i++) {
        this.vertices.push(points[i * 3]);
        this.vertices.push(points[i * 3 + 1]);
        this.vertices.push(points[i * 3 + 2]);
        this.vertices.push(points[i * 3]);
        this.vertices.push(points[i * 3 + 1]);
        this.vertices.push(points[i * 3 + 2]);
    }
    ...
    for (let i = 0; i < this.count - 1; i++) {
        ...
        this.indices.push(i * 2 + 1);
        this.indices.push(i * 2 + 2);
        this.indices.push(i * 2 + 2);
        this.indices.push(i * 2 + 1);
        this.indices.push(i * 2 + 3);
    }
}
...
function main() {
    ...
    for (let i in curveData) {
        let curve = new Curve(curveData[i]);
        curves.push(curve);
    }
    ...
    function drawScene() {
        ...
        for (let i in curves) {
            ...
            gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, new Uint16Array(curve.indices), gl.STATIC_DRAW);
