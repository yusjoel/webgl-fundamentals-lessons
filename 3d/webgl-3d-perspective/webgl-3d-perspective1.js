...
function main() {
    ...
    var translation = [0, 50, -350];
    var rotation = [0, 0, 0];
    var scale = [1, 1, 1];
    var color = [Math.random(), Math.random(), Math.random(), 1];

    var angles = [0, 220, 160];
    for (var i = 0; i < 3; i++) {
    ...
    var perspectiveOption = [near, far, fieldOfViewInRadians, aspect, fieldOfViewInDegrees];
    ...
    webglLessonsUI.setupSlider("#z", {value: translation[2], slide: updatePosition(2), min: -800, max: 800});
    ...
    webglLessonsUI.setupSlider("#near", {value: perspectiveOption[0], slide: updatePerspective(0), min: -600, max: 600});
    webglLessonsUI.setupSlider("#far", {value: perspectiveOption[1], slide: updatePerspective(1), min: -600, max: 600});
    webglLessonsUI.setupSlider("#fieldOfView", {
        value: perspectiveOption[4],
        slide: updatePerspective(4),
        min: 0,
        max: 180
    });

    function updatePerspective(index) {
        return function (event, ui) {
            perspectiveOption[index] = ui.value;
            perspectiveOption[2] = perspectiveOption[4] * Math.PI / 180
            drawScene();
        }
    }
    ...
    function drawScene() {
        ...
        // 计算投影矩阵
        var projectMatrix = m4.perspective(perspectiveOption[0], perspectiveOption[1], perspectiveOption[2], perspectiveOption[3]);
