...
function main() {
    ...
    var enableBackCulling = false;
    const uiElem = document.querySelector("#ui");
    var checkbox = webglLessonsUI.makeCheckbox({
        name: "enableBackCulling",
        value: false,
        change: function (e, uiInfo) {
            enableBackCulling = uiInfo.value;
            drawScene();
        }
    });
